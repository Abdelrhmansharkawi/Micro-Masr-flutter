class AppStrings {
  ...
  static const String passengerOnboarding1Subtitle =
      "  شاهد الميكروباصات المتاحة حواليك في الوقت الحقيقي ";
  static const String passengerOnboarding2Title = 'احجز مقعدك مسبقاً';
  static const String passengerOnboarding2Subtitle =
      "اختار مقعدك وامن حجزك قبل ما توصل المحطة";
  static const String passengerOnboarding3Title = 'سافر بأمان وذكاء';
  static const String passengerOnboarding3Subtitle =
  ...
  static const String pendingVerificationBody =
  ...
  static const String bookingConfirmedAlertBody =
      'رحلة محطة مصر ← الجامعة، مقعد 3';
  ...
  static const String specialOfferAlertBody =
      'احصل على 20% خصم على رحلتك الجاية';
  ...
  static const String uploadDocumentsSubtitle = 'سيتم مراجعتها خلال ٢٤-٤٨ ساعة';
